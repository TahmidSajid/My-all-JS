...
// var name = prompt("insert the word");
...
// document.write(`vowle number is ${v_number}`);
// document.write(`consonant number is ${c_number}`);

// var text = ["tanim","sajid","abul","kabul"];
...
// var number = [30,20,40,800,300];

// var all = number.sort(function(a,b){
//     return a-b;
// })
...
// var icons = {"name":"Font Awesome v5.0.1", "icons":[
//     "fab fa-500px",
...
// var icon_list = icons.icons;
// var myTag = document.getElementsByTagName("i")[0];
// var myInput = document.getElementsByTagName("input")[0]
// var myDiv = document.getElementsByClassName("mylist")[0];
// console.log(myDiv);

// icon_list.forEach(element => {
//     console.log(element);
//     var icon_tag = document.createElement("i");
//     myDiv.appendChild(icon_tag);
//     icon_tag.setAttribute("class",element);
//     icon_tag.addEventListener("click",function(){
//         myTag.setAttribute("class",element);
//         myInput.setAttribute("value",element);
//     })
// });



// for(var x=0;x<button_len;x++){
//     var button = document.createElement("button");
//     button.classList.add("fab");
//     button.classList.add(`${icon_list[x]}`);
//     myDiv.appendChild(button);
//     button.addEventListener("click",function(){
//         let className = icon_list;
//         console.log(className);
//         myTag.classList.toggle(`${className["x"]}`);
//     })
...
// button.setAttribute("onclick", `${[x]+"my"}()`)

// let functionName = [x]+"my";
// functionName =()=>{
//     myfunction(icon_list[x]);
// }
...
// var number = 1;
// document.write('<table style="table-border:1px; border-color:black">');
// for(x=1;x<11;x++){
//     document.write('<tr>');
//     var limit = number+10;
//     for(y=number;y<limit;y++){
//         document.write('<td>');
//         document.write(y);
//         document.write('</td>');
//     }
...
// var list = [["sajid","15"],["tanim","16"],["emon","21"],["nayeem","17"],["ripon","2"]];
...
// var student1 = new details('sajid',22,'xii',30);
...
//         document.getElementsByClassName('logo')[0].classList.add("vanish");
//     }
//     else{
//         document.getElementsByClassName('logo')[0].classList.remove("vanish");
//     }
// }
// ;
